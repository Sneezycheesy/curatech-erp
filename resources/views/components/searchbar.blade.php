...
-->
<form {{ $attributes->merge(['class' => "grid grid-cols-12 gap-x-2 mt-5 py-7 px-7 bg-cbg-200 dark:text-paragraph-dark dark:bg-cbg-700 max-w-7xl mx-auto h-max rounded"]) }}>
