...
<div class="absolute top-0 left-0 opacity-25 bg-cbg-800 dark:bg-white w-full h-full"
    x-show="modal_open"
...
<form action="" method="post" class="opacity-100 grid grid-cols-1 rounded auto-rows-max absolute w-1/4 h-min dark:bg-cbg-800 bg-cbg-200 py-4 px-3 gap-y-3 place-self-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
x-show="modal_open"        
