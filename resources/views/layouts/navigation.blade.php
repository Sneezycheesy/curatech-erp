<nav x-data="{ open: false }" class="sticky bg-background-light dark:bg-background-dark border-b border-bdr-light dark:border-bdr-dark">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-cbg-200 dark:border-cbg-600">
            <div class="px-4">
                <div class="font-medium text-base text-cbg-800 dark:text-cbg-200">{{ Auth::user()->name }}</div>
                <div class="font-medium text-sm text-cbg-500">{{ Auth::user()->email }}</div>
            </div>
