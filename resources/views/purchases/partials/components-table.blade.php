...
@foreach ($components as $component)
    @php $i = !$i @endphp
    <div class="grid py-3 gap-x-1 grid-flow-col grid-cols-6 mx-auto text-center h-max-h-400 hover:bg-red-200 {{$i ? 'bg-gray-200 dark:bg-gray-700' : 'bg-gray-300 dark:bg-gray-600'}}">
        <div class="items-end">
